...
var AppdataDir: String;    //rajoutté par nico
    AppDir:string;
    MusicDir:string;
    TempDir:String;
    //ShotDir:string;
...
//ar AppdataDir,ShotDir: String;    //rajoutté par nico
...
begin
  ...
  repeat
    ...
    //if not ReadFile(hPipe,Buffer[0],BufSize,BytesRead,nil) then break;//error
...
begin
  ...
  //WriteFile(pr.WritePipe,Command[1],length(Command),Dummy,nil); //error
